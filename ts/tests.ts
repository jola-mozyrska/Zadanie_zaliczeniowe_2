...
describe("check solving quiz", () => {
    it("check timer", async () => {
        await loginUser1(driver);
        await driver.find('body > p:nth-child(7) > a:nth-child(1)').click();
        await driver.find('body > ul:nth-child(7) > li:nth-child(1) > a:nth-child(1)').click();
        await driver.find('body > p:nth-child(9) > a:nth-child(1)').click();
        ...
        let sumSavedTimes = 0;
        for(let i = 1; i <= 4; ++i) {
            savedTimes.push(parseInt (await driver.find(`body > table:nth-child(8) > tbody:nth-child(2) > tr:nth-child(${i}) > th:nth-child(5)`).getText(), 10));
    ...
    it("disabledQuiz", async () => {
        await driver.find('body > p:nth-child(6) > a:nth-child(1)').click();
        await driver.find('body > ul:nth-child(7) > li:nth-child(1) > a:nth-child(1)').click();
        await driver.find('body > p:nth-child(9) > a:nth-child(1)').click();
